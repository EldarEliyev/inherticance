...
#         self.cards = []  # Oyunçunun kartları
        
#     def add_card(self, card):
#         self.cards.append(card)
        
#     def show_cards(self):
#         return f"{self.nickname}'s cards: {self.cards}"


# deck = ["+2", "reverse", "skip", "1", "2", "3", "4", "+2", "reverse", "skip"]
...
#     if "+2" in player.cards:
#         print(f"{player.nickname} gets +2 penalty!")
#     if "reverse" in player.cards:
#         print(f"Game direction is reversed for {player.nickname}!")
#     if "skip" in player.cards:
#         print(f"{player.nickname} is skipped!")
